...
pub type ExecutionPayloadMerge = eth2_types::ExecutionPayloadMerge<eth2_types::MainnetEthSpec>;
pub type ExecutionPayloadCapella = eth2_types::ExecutionPayloadCapella<eth2_types::MainnetEthSpec>;
